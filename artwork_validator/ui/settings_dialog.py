...
"""
Dialogue de paramètres et configuration de l'application
...
class SettingsDialog(QDialog):
    """Dialogue de paramètres et configuration"""
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle("⚙️ Paramètres & Configuration")
    ...
    def create_buttons(self):
        """Crée les boutons du bas du dialogue"""
        container = QFrame()
        container.setStyleSheet(f"""
            QFrame {{
                background-color: {LorealStyles.COLORS['surface']};
                border-top: 1px solid {LorealStyles.COLORS['border']};
                padding: 15px;
            }}
        """)
